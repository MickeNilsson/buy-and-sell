...
function sendMessage($to_s, $message_s) {
    ...
    $htmlMail_s = '<!DOCTYPE html>'
                ...
                . '<div>'
                . '<div>Hej, du har fått ett svar på din annons på buyandsell.se:</div>'
                . '<div>' . $message_s . '</div>'
                . '</div>'
                . '</body>'
                . '</html>';
    ...
    $mailWasSent_b = mail($to_s, 'Ett svar på din annons på buyandsell.se!', $htmlMail_s, $headers_s);
