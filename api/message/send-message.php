...
function sendMessage($ad_aa, $message_s) {
    ...
    $htmlMail_s = '<!DOCTYPE html>'
                ...
                . '<div>'
                . '<div>Hej, du har fått ett svar på din annons som har rubriken "' . $ad_aa['header'] . '".</div>'
                . '<br>'
                . '<div>Svar: ' . $message_s . '</div>'
                . '<br>'
                . '<div>Du hittar din annons <a target="_blank" href="http://digizone.se/buy-and-sell/?id=' . $ad_aa['id'] . '">här</a>.'
                . '</div>'
                . '</body>'
                . '</html>';
